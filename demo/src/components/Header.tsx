...
import { BookOpen, Home, Menu, Users, X } from 'lucide-react';
        ...
        <>
                ...
                <h1 className="ml-4 text-xl font-semibold">
                    <Link to="/" className="flex items-center gap-2">
                        ...
                        <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent font-bold">
                            Ketab Online SDK v{packageJson.dependencies['ketab-online-sdk'].replace('^', '')}
                        </span>
                    </Link>
                </h1>
            </header>
            ...
            >
                ...
                <div className="p-4 border-t border-gray-700 text-center text-gray-400 text-sm">
                    Powered by{' '}
                    <a
                        href="https://github.com/ragaeeb/ketab-online-sdk"
                        target="_blank"
